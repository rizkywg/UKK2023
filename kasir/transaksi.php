                        ...
                        <tbody>
                            ...
                            <?php foreach($data as $transaksi): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                          <a href="transaksi_detail.php?id=<?= $transaksi['id_transaksi']; ?>" data-toggle="tooltip" data-placement="bottom" title="Detail" class="btn btn-success btn-block"><i class="fa fa-eye fa-fw"></i> Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
