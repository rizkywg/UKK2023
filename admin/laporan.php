        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box" style="margin-top:0px">
                ...
                <div class="table-responsive">
                    ...
                    <a href="cetak_laporan.php" data-toggle="tooltip" data-placement="bottom" title="Detail" class="btn btn-success btn-block"><i class="fa fa-print fa-fw" aria-hidden="true"></i> Cetak Laporan</a>
                    </div>
                </div>
            </div>
        </div>
